...
import { nodeVoltage, isThreePhase, computeCurrentA, sourceImpedance, nodeWireCount, cableVoltageClass } from './electrical.js';
...
export function bindInspectorDeps({ render, deleteNode, deleteConn, isTagUnique }) {
  ...
  // Прокидываем renderInspector в отдельные модули (UPS, ...).
  // Используем forward-reference чтобы избежать circular import.
