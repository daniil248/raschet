...
export const APP_VERSION = '0.59.495';
...
export const DEFAULTS = {
  ...
  panel:     () => ({
    ...
    marginMinPct: 2,
    marginMaxPct: 30,
    // Daisy-chain определяется АВТОМАТИЧЕСКИ: если на входном порту щита
    // подключено ≥2 линии, этот щит и peer-щиты на том же терминале
    // образуют цепочку. Один автомат upstream защищает все кабели;
    // сечения подбираются по суммарной нагрузке цепочки.
