...
function init() {
  ...
  mountHelp({
    ...
    usage: `
      ...
      <ol>
        <li><b>Жёсткая (неподвижная) опора</b> — оранжевый квадратик — ставится у каждого фитинга/насадка, на <code>pad = min(0.3 м; 0.1·L)</code> от узла со стороны подходящего участка. Фиксирует направление трубопровода и воспринимает осевые усилия.</li>
        <li><b>Скользящая (подвижная) опора</b> — белый кружок — ставится вдоль прямых участков между жёсткими. Расстояние между любыми двумя соседними опорами не превышает <code>supportStep(DN)</code>.</li>
