  ...
  mountHelp({
    ...
    usage: `
      ...
      <ol>
        ...
        <li><b>T-отвод вниз запрещён для halocarbon.</b> Т-отвод в −Y от горизонтальной трубы помечается как нарушение — жидкая фаза стекает в отвод (предупреждение).</li>
      </ol>
