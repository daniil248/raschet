...
`dialog.js`, `discipline-context.js` (реестр контекст-палитр
Конструктора, D3/X.4.5.3 — чистые данные, БЕЗ import модулей/ядра;
Конструктор читает по state.project.discipline), `disciplines.js`
(реестр-шов дисциплин ↔ calc-lib
