...
export const CHANGELOGS = {
  ...
  'rack-config': [
    { version: '0.59.135', date: '2026-04-21', items: [
      'Кнопка помощи «?» прячется на время открытия PDU-модалки и возвращается при её закрытии — больше не проглядывает через затемнение рядом с нижними кнопками iframe. Файл: rack-config/rack-config.js (openPduWizardModal).'
    ] },
