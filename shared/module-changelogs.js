...
export const CHANGELOGS = {
  ...
  'cable': [
    { version: '0.59.140', date: '2026-04-21', items: ['Выпадающий «Характеристика автомата» в расчёте кабельной линии синхронизируется с подобранным номиналом In: MCB (IEC 60898-1, ≤125 А) отключается если In>125 А, MCCB (IEC 60947-2, ≤1600 А) — если In>1600 А (остаётся только ACB). Если пользовательский выбор вышел за физические границы класса — автоматически переключается на корректный. Файл: cable/cable-calc.js (syncBreakerCurveOptions).'] },
