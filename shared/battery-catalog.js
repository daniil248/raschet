// ======================================================================
// shared/battery-catalog.js
// Справочник АКБ, сохраняемый в localStorage. SHARED-контракт —
// может использоваться из любой подпрограммы Raschet (разряд АКБ в
// standalone-режиме, выбор АКБ в инспекторе ИБП и т.п.).
// Зеркало shared/ups-catalog.js. Старый путь battery/battery-catalog.js
// сохранён как shim (export *) для обратной совместимости импортов.
//
