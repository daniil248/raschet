// =============================================================================
// shared/meteo-bridge.js — канонический мост к данным модуля Meteo
// =============================================================================
// (перенесён из apps/cooling/meteo-bridge.js в каноничное место shared/,
//  v0.60.550, Фаза 2: мосты живут в shared/. Старый путь — re-export shim.)
