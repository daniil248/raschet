...
export const ELEMENT_KINDS = {
  ...
  dgu:           { category: 'equipment', label: 'ДГУ (дизель-генераторная установка)', pricable: true,
                   note: 'Дизель-генераторы по ISO 8528-1 (режимы ESP/PRP/COP). Datasheets из dgu-config/datasheets/ (Caterpillar / Cummins / Volvo Penta / FG Wilson). Поле series = engineModel, variant = nameplate kW + cylinders.' },
