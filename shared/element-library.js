...
export const ELEMENT_KINDS = {
  ...
  climate:       { category: 'equipment', label: 'Климатическое оборудование', pricable: true,
                   note: 'Чиллеры / прецизионные кондиционеры (CRAC) / DX-системы / In-row. Datasheets из cooling/datasheets/ (Daikin / York / Carrier / Trane / Stulz / Vertiv / Kehua / Generic). Поле series = chiller/crac/dx, variant = systemType (chiller / dx-air / dx-pumped-fc / crac-water).' },
  dgu:           { category: 'equipment', label: 'ДГУ (дизель-генераторная установка)', pricable: true,
                   note: 'Дизель-генераторы по ISO 8528-1 (режимы ESP/PRP/LTP/COP) и ISO 8528-13 (DCC/DCP/DCS/MCSP для ЦОД). Datasheets из shared/catalogs/dgu.js (Caterpillar / Cummins / Volvo Penta / FG Wilson / MTU). Каталог расширен до 2500 кВА (v0.60.92).' },
  drups:         { category: 'equipment', label: 'DRUPS (дизель-динамический ИБП)', pricable: true,
                   note: 'Diesel Rotary UPS — гибрид: маховик (5-15 сек) + дизель-генератор + синхронная машина на одном валу. Hitec / Piller / Euro-Diesel. Без батарей, КПД 96-97%, срок 25-30 лет. Datasheets из shared/catalogs/drups.js (v0.60.92).' },
