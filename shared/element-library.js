...
export const ELEMENT_KINDS = {
  ...
  dgu:           { category: 'equipment', label: 'ДГУ (дизель-генераторная установка)', pricable: true,
                   note: 'Дизель-генераторы по ISO 8528-1 (режимы ESP/PRP/LTP/COP) и ISO 8528-13 (DCC/DCP/DCS/MCSP для ЦОД). Datasheets из shared/catalogs/genset/ (Caterpillar / Cummins / Volvo Penta / FG Wilson / MTU). Каталог расширен до 2500 кВА (v0.60.92).' },
