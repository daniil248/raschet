...
const SCHEMATIC_FIELDS = {
  consumer: [
    ...
    { id: 'breakerIn',    label: 'Номинал автомата (А)',       shortLabel: 'Iавт',        unit: 'А',   group: 'electrical' },
    ...
    { id: 'freeKw',       label: 'Свободная мощность (кВт)',   shortLabel: 'Своб. P',     unit: 'кВт', group: 'electrical' },
    { id: 'freeA',        label: 'Свободный ток (А)',          shortLabel: 'Своб. I',     unit: 'А',   group: 'electrical' },
