...
// D4/D5 (v0.60.598): уже мультинорма (СП РК/СП 485/+Прил.Д/NFPA/ISO),
// каждый стандарт = отдельный файл. Гармонизировано к контракту:
// META +version/enabled; реестр из массива с enabled-фильтром +
// ALL_META. METHODS/METHOD_LIST/run — backward-compat (потребитель
// suppression-config). Добавить стандарт/версию = +1 импорт +1 в _ALL;
// отключить = META.enabled:false (исчезает из picker, id сохраняется).
const _ALL = [SPRK, SP485, SP485AD, NFPA, ISO];
