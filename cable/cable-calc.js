...
function calculate() {
  ...
  // MCB (IEC 60898-1) физически ограничен 125 А, MCCB (IEC 60947-2) — до 3200 А
  // (ABB Tmax T8, Schneider Compact NS), всё выше — ACB. Отключаем недоступные
  // варианты и, если текущий выбор вышел за границы, мягко переключаем
  // пользователя на корректный класс.
