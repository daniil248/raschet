...
// v0.60.547: tech-workspace в apps/tech-workspace/ (глубина 2),
// MODULE_PATHS — пути от корня сайта (apps/<id>/). Префикс '../../'
// поднимает из apps/tech-workspace/ к корню, далее apps/<id>/.
