...
> **Статус:** v0.60.585 (2026-05-17). Текущий приоритет — **архитектурная
...
- [ ] X.4.5 **Архитектурные дополнения Пользователя (2026-05-17)** —
  ...
  - X.4.5.4 D4: каждый обособленный метод (стандарт/методика) —
    отдельный файл + picker. Декомпозировать электрические расчёты
    по стандартам (IEC/ГОСТ/СП); расширить picker во всех calc-libs.
