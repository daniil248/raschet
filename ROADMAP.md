...
> **Статус:** v0.60.589 (2026-05-17). Текущий приоритет — **архитектурная
...
- [ ] X.4.5 **Архитектурные дополнения Пользователя (2026-05-17)** —
  ...
  - [~] X.4.5.5 D5: мультинорма (РФ + КЗ СН/СП РК + ISO/IEC) +
    ...
    METHOD_LIST=5. Осталось: hydraulic/hvac/suppression мультинорма
    + электрика js/calc (IEC/ГОСТ/СП/СТ РК) — следующими шагами.
