...
> **Статус:** v0.60.582 (2026-05-17). Текущий приоритет — **архитектурная
...
- X.4.4-producer (в работе): Increment A ✅ (v0.60.581) — декларативная
  ...
  round-trip). lib грузится lazy по URL ../../lib/<spec>. Осталось B2:
  project-level «📑 Сводный отчёт» → cross-discipline.js → reports/.
