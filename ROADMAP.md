...
> **Статус:** v0.60.575 (2026-05-17). Текущий приоритет — **архитектурная
...
- [~] X.4.1 Расчётные движки per-discipline: hydraulic (расход/давление/
  ...
  психрометрия влажного воздуха; контракт {META,compute}/run(),
  manifest+modules.json+REGISTRY_ORDER, parity 10/10.
  Осталось: `lib/gas-methods` + UI-потребитель
  (модуль ОВиК / гидравлики / cross-discipline отчёт).
