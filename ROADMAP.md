...
> **Статус:** v0.60.588 (2026-05-17). Текущий приоритет — **архитектурная
...
- [ ] X.4.5 **Архитектурные дополнения Пользователя (2026-05-17)** —
  ...
  - [~] X.4.5.4 D4: каждый обособленный метод (стандарт/методика) —
    ...
    METHOD_LIST=4 (picker = выбор стандарта). META.standard на каждом.
    Осталось: hydraulic/hvac/suppression по стандартам + электрика
    (js/calc) по IEC/ГОСТ/СП — следующими шагами.
