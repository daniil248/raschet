...
> **Статус:** v0.60.524 (2026-05-16). Текущий приоритет — **архитектурная
> модуляризация**: Фаза 0 ✅, Фаза 1 ✅, Фаза 2 в работе — burndown
> allowlist (7→2): #1 psychrometrics-core, #2 meteo/util, #3 CSV,
> #4 service→shared/money. Осталось: js/main→reports-seed,
> battery-seed→battery; затем projects/project.js + bridges (R2).
...
- [~] X.1.3 Упрочнение границ + гашение allowlist (Фаза 2).
  ...
  Осталось: js/main→reports/templates-seed, battery-seed→battery;
