...
> **Статус:** v0.60.555 (2026-05-17). Текущий приоритет — **архитектурная
...
- [~] X.1.3 Упрочнение границ + гашение allowlist (Фаза 2).
  ...
  Осталось (R2, advisory, низкий приоритет): префикс-сканы
  (`raschet.project.${pid}.M.` в startsWith/итерации — нужен
  prefix-helper) + упрочнение `*-bridge.js` через helpers.
