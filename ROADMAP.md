...
> **Статус:** v0.60.573 (2026-05-17). Текущий приоритет — **архитектурная
...
- [~] X.4.1 Расчётные движки per-discipline: hydraulic (расход/давление/
  ...
  Осталось: `lib/hvac-methods`, `lib/gas-methods` + UI-потребитель
  (модуль гидравлики / cross-discipline отчёт).
