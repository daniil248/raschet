# Raschet — Роадмап (10 разделов, переработан)

> **Статус:** v0.60.742 (2026-05-18). Платформа Конструктора схем +
> предметные модули. Мультидисциплинарность (X.4.5.3 Вариант I) —
