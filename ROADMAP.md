...
> **Статус:** v0.60.526 (2026-05-16). Текущий приоритет — **архитектурная
> модуляризация**: Фаза 0 ✅, Фаза 1 ✅, Фаза 2 — allowlist жёстких
> нарушений **погашен полностью (7→0)**: #1 psychrometrics-core,
> #2 meteo/util, #3 CSV, #4 service→money, #5 battery-catalog→shared,
> #6 reports-seed→shared. Осталось (R2, advisory): projects/project.js
> (15+ чужих LS) + упрочнение `*-bridge.js` через project-storage.
