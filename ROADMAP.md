...
>
> **Статус:** v0.60.777 (2026-05-18). Платформа + предметные модули.
...
- [~] **8.0.1 Self-host на Timeweb VPS + уход от Firebase** (решение
  ...
  доказан e2e; v777 +pushAll/меню синхронизации + restore→Postgres
  для переноса данных git-копии). Остаток: C2 auth — рекоменд. авторизовать домен
