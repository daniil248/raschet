...
> **Статус:** v0.60.604 (2026-05-17). Текущий приоритет — **архитектурная
...
- [ ] X.4.5 **Архитектурные дополнения Пользователя (2026-05-17)** —
  ...
  - [~] X.4.5.3 D3: Конструктор — ОДИН app, единый интерфейс для
    ...
    проекта. Осталось: реальная разводка инструментов non-electrical
    + (опц.) смена контекста без перезаписи project.discipline.
