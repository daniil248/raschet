...
export const MODULE_CHANGELOG = [
  ...
  },
  {
    ...
    date: '2026-04-22',
    items: [
      'rack.html — новый layout: карта юнитов перенесена в центральную колонку (main.sc-mapcol), каталог + размещение + матрица + BOM + проверки — в правой колонке. Сайдбар шкафов — слева. Ширины: <code>220px · 1.5fr · minmax(360px, 1fr)</code>. На экранах &lt;1280px правая колонка растягивается в отдельный ряд; &lt;1000px — однокомпонентный режим.',
      'Fix: внутри шкафа юниты не перемещались из-за бага в <code>canPlace()</code> — первый цикл считал верхние <code>r.occupied</code> юнитов «стопкой» занятыми, независимо от реальных позиций устройств. Второй цикл уже корректно проверял overlap по всем устройствам, поэтому удалён первый. Теперь drag-n-drop внутри стойки (и межстоечный) работает.',
    ],
  },
  {
    version: '0.1.23',
